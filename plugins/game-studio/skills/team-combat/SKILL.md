...
- **engine specialist** (primary) — Validate architecture and implementation patterns are idiomatic for the engine (read from `.game-studio/project-profile.md` Engine Specialists section)
