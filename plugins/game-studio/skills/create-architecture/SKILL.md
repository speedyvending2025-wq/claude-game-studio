...
3. `.game-studio/project-profile.md` — naming conventions, performance budgets,
...
Apply gate **TD-ARCHITECTURE** (`references/director-gates.md`) as a self-review. Check all four criteria from that gate definition against the completed document.
...
**Step 2 — Spawn `lead-programmer` via Task using gate LP-FEASIBILITY (`references/director-gates.md`):**
