...
Check:
- **Engine configured?** Read `.game-studio/project-profile.md`. If the Engine field contains `[TO BE CONFIGURED]`, the engine is not set.
...
- **Prompt**: "Welcome to Claude Desktop/Cowork Game Studios! Before I suggest anything, I'd like to understand where you're starting from. Where are you at with your game idea right now?"
- **Options**:
