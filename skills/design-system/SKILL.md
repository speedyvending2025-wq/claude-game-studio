...
- Read `.game-studio/project-profile.md` to identify the engine and version
...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`references/director-gates.md`).
...
> **To validate this GDD, open a fresh Claude Desktop/Cowork session and run:**
...
> open a fresh Claude Desktop/Cowork session and run `/design-system [system-name]` — it will
