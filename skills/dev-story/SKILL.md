...
### Engine reference
Read `.game-studio/project-profile.md`:
...
Read the `Engine Specialists` section of `.game-studio/project-profile.md`
...
5. **Engine preferences**: `.game-studio/project-profile.md` — read naming conventions and performance budgets
